        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 shadow">
                    <!--Album Cover-->
                    <h2 class="text-center">The Game</h2>
                    <!--Track Listing-->
                    <div class="col-lg-8">
                        <div class="box">
                            <div class="box-image">
                                <!--Album cover image source = http://www.onemusicapi.com/artists/album-covers/Queen.html-->
                                <img class="img-fluid" alt="A Night at the Opera Cover" src="../photos/album-covers/the_game.jpg">
                                Released In 30 June 1980 <br>Length: 36 mins
                                <br>
                                Rate the Album!
                            </div>
                            <ol>
                                ...
                                <li>Need Your Loving Tonight</li>
                                <li>Crazy Little Thing Called Love</li>
                                <li>Rock It</li>
                                <li>Don't Try Suicide</li>
                                <li>Sail Away Sweet Sister</li>
                                <li>Coming Soon</li>
                                <li>Save Me</li>
                            </ol>
                        </div>
                    ...
                    <div class="container">
                        <form method="POST" id="comment_form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="comment_id" id="comment_id" value="The_Game"/>
