        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 shadow">
                    <!--Album Cover-->
                    <h2 class="text-center">Innuendo</h2>
                    <!--Track Listing-->
                    <div class="col-lg-8">
                        <div class="box">
                            <div class="box-image">
                                ...
                                Released In 4 February 1991<br>Length: 54 mins
                                <br>
                                Rate the Album!
                            </div>
                                <ol>
                                    <li>Innuendo</li>
                                    <li>I'm Going Slightly Mad</li>
                                    <li>Headlong</li>
                                    <li>I Can't Live With You</li>
                                    <li>Don't Try So Hard</li>
                                    <li>Ride the Wild Wind</li>
                                    <li>All God's People</li>
                        ...
                        <div class="Album-Links">
                            <a href="https://open.spotify.com/album/56wLOf3aYbAiJ4FkexpRMj?si=tRBD2lvPRUmS62q9IjLfkg">
                                <!--Spotify - https://www.flaticon.com/free-icon/spotify_2111624-->
                                <img class="img-fluid" src="../photos/app-icons/spotify.png" alt="Spotify">
                            </a>
                            <a href="https://music.apple.com/us/album/innuendo/1440806201">
                    ...
                    <div class="container">
                        <form method="POST" id="comment_form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="comment_id" id="comment_id" value="Innuendo" />
                ...
                <div class="col-lg-4">
                    ...
                    <div class="aside-post">
                        <a href="hot_space.php">
                            <!--Album cover image source = http://www.onemusicapi.com/artists/album-covers/Queen.html-->
                            <img class="img-fluid" alt="" src="../photos/album-covers/Hot-Space.jpg">
                        </a>
                        <div class="aside-content">
                            <a href="hot_space.php"><h3>Hot Space</h3></a>
                        </div>
                    </div>
